...
part of 'shipment_approval_screen_state.dart';
...
/// @nodoc
mixin _$ShipmentApprovalScreenState {
  ...
  String get pickUpTemperature => throw _privateConstructorUsedError;
  ...
  $ShipmentApprovalScreenStateCopyWith<ShipmentApprovalScreenState>
  get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ShipmentApprovalScreenStateCopyWith<$Res> {
  factory $ShipmentApprovalScreenStateCopyWith(
    ShipmentApprovalScreenState value,
    $Res Function(ShipmentApprovalScreenState) then,
  ) =
      _$ShipmentApprovalScreenStateCopyWithImpl<
        $Res,
...
/// @nodoc
class _$ShipmentApprovalScreenStateCopyWithImpl<
  $Res,
  $Val extends ShipmentApprovalScreenState
>
    implements $ShipmentApprovalScreenStateCopyWith<$Res> {
  _$ShipmentApprovalScreenStateCopyWithImpl(this._value, this._then);
      ...
      _value.copyWith(
            ...
            shipments: null == shipments
                ...
                : shipments // ignore: cast_nullable_to_non_nullable
                      as List<Shipment>,
            pickUpTemperature: null == pickUpTemperature
                ? _value.pickUpTemperature
                : pickUpTemperature // ignore: cast_nullable_to_non_nullable
                      as String,
...
/// @nodoc
abstract class _$$ShipmentApprovalScreenStateImplCopyWith<$Res>
    implements $ShipmentApprovalScreenStateCopyWith<$Res> {
  factory _$$ShipmentApprovalScreenStateImplCopyWith(
    _$ShipmentApprovalScreenStateImpl value,
    $Res Function(_$ShipmentApprovalScreenStateImpl) then,
  ) = __$$ShipmentApprovalScreenStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    MovementType movementType,
...
/// @nodoc
class __$$ShipmentApprovalScreenStateImplCopyWithImpl<$Res>
    extends
        _$ShipmentApprovalScreenStateCopyWithImpl<
          $Res,
          _$ShipmentApprovalScreenStateImpl
        >
    implements _$$ShipmentApprovalScreenStateImplCopyWith<$Res> {
  __$$ShipmentApprovalScreenStateImplCopyWithImpl(
    _$ShipmentApprovalScreenStateImpl _value,
    $Res Function(_$ShipmentApprovalScreenStateImpl) _then,
  ) : super(_value, _then);
...
class _$ShipmentApprovalScreenStateImpl extends _ShipmentApprovalScreenState {
  const _$ShipmentApprovalScreenStateImpl({
    required this.movementType,
    required this.pickUpFacility,
    required this.destinationFacility,
    required final List<Shipment> shipments,
    this.pickUpTemperature = "",
    this.fullName = "",
    this.phoneNumber = "",
    this.designation = "",
    this.signature = "",
  ...
  @override
  @JsonKey()
  final String pickUpTemperature;
  @override
  @JsonKey()
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ShipmentApprovalScreenStateImpl &&
            ...
            (identical(other.pickUpTemperature, pickUpTemperature) ||
                other.pickUpTemperature == pickUpTemperature) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ShipmentApprovalScreenStateImplCopyWith<_$ShipmentApprovalScreenStateImpl>
  get copyWith =>
      __$$ShipmentApprovalScreenStateImplCopyWithImpl<
        _$ShipmentApprovalScreenStateImpl
      >(this, _$identity);
...
abstract class _ShipmentApprovalScreenState
    extends ShipmentApprovalScreenState {
  const factory _ShipmentApprovalScreenState({
