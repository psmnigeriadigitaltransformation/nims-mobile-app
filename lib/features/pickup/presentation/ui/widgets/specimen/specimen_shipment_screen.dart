      ...
      data: (state) => PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) {
            ...
            ref.read(shipmentsScreenStateNotifierProvider(_providerKey).notifier).clearCache();
          }
        },
                            ...
                            return Padding(
                              ...
                              child: NIMSShipmentCard(
                                ...
                                onTap: () {
                                  ...
                                  final currentState = ref.read(shipmentsScreenStateNotifierProvider(_providerKey)).value;
