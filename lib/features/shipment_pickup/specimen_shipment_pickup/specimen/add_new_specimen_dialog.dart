...
class _AddNewSpecimenDialogState extends State<AddNewSpecimenDialog> {
  ...
  // Generate sample code using manifestNo and next sample index (1-based)
  String get sampleCode => '${widget.manifestNo}-${widget.currentSampleCount + 1}';
