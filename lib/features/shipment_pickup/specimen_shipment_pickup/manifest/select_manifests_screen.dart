...
import 'package:nims_mobile_app/features/shipment_pickup/specimen_shipment_pickup/manifest/providers.dart';
...
class SelectManifestsScreen extends ConsumerStatefulWidget {
  final DomainMovementType movementType;

  const SelectManifestsScreen({super.key, required this.movementType});

  @override
  ConsumerState<SelectManifestsScreen> createState() => _SelectManifestsScreenState();
}

class _SelectManifestsScreenState extends ConsumerState<SelectManifestsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final asyncValueState = ref.watch(
      selectManifestsScreenStateNotifierProvider((movementType: widget.movementType)),
    );
