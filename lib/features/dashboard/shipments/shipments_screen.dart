...
import '../shipments/providers.dart';

class ShipmentsScreen extends ConsumerWidget {
  final TextEditingController searchBarController = TextEditingController();

  ShipmentsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncState = ref.watch(shipmentsScreenStateNotifierProvider);
      ...
      header: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              "These are the shipments you have created",
            ...
            Container(
              ...
              child: SearchBar(
                hintText: "Search for shipments",
                controller: searchBarController,
                onChanged: (value) => {
                  searchBarController.text = value,
                  ref
                      .read(shipmentsScreenStateNotifierProvider.notifier)
          ...
          return SizedBox(
            ...
            child: Padding(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  if (state.shipments.isNotEmpty) _buildList(state.shipments),
                ],
              ),
            ),
          );
...
SliverList _buildList(List<DomainShipment> items) {
  return SliverList(
    delegate: SliverChildBuilderDelegate((context, index) {
      return Padding(
        padding: EdgeInsetsGeometry.symmetric(vertical: 4),
        child: NIMSSpecimenShipmentSummaryCard(shipment: items[index]),
      );
