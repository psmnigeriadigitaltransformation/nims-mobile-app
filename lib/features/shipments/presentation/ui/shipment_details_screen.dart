...
import 'package:nims_mobile_app/features/shipments/presentation/providers.dart';
...
class ShipmentDetailsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncState = ref.watch(
      shipmentDetailsScreenStateNotifierProvider(shipment),
    );
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          _buildStatusChip(state.shipment.shipmentStatus),
                        ],
                      ),
