...
_$ResultPickupRequestImpl _$$ResultPickupRequestImplFromJson(
  ...
  shipment: ResultPickupShipment.fromJson(
    json['shipment'] as Map<String, dynamic>,
  ),
  samples: (json['samples'] as List<dynamic>).map((e) => e as String).toList(),
  approval: ResultPickupApproval.fromJson(
    json['approval'] as Map<String, dynamic>,
  ),
);

Map<String, dynamic> _$$ResultPickupRequestImplToJson(
  _$ResultPickupRequestImpl instance,
) => <String, dynamic>{
...
_$ResultPickupShipmentImpl _$$ResultPickupShipmentImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ResultPickupShipmentImplToJson(
  _$ResultPickupShipmentImpl instance,
) => <String, dynamic>{
...
_$ResultPickupApprovalImpl _$$ResultPickupApprovalImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ResultPickupApprovalImplToJson(
  _$ResultPickupApprovalImpl instance,
) => <String, dynamic>{
