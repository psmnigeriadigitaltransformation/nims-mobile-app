...
part 'create_shipment_route_request_body.freezed.dart';
part 'create_shipment_route_request_body.g.dart';

@freezed
class CreateShipmentRouteRequest with _$CreateShipmentRouteRequest {
  const factory CreateShipmentRouteRequest({
  ...
  }) = _CreateShipmentRouteRequest;

  factory CreateShipmentRouteRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateShipmentRouteRequestFromJson(json);
}
